import { ExplorerDataset, fetchExplorerDataset, toCveRows } from '@/lib/explorerDataset';
...
export class CveService {
  ...
  fromDataset(dataset: ExplorerDataset): CveTableRowItem[] {
    return toCveRows(dataset).map((row: any): CveTableRowItem => {
